...
def main(args):
    ...
    visualize_box_samples(sample_dataset, num_samples=6,
                          save_path='visualizations/box_samples.png')
    ...
    model = get_segmentation_model(
        args.model_name, in_channels=3, out_channels=1)
    ...
    val_results = evaluate_segmentation_model(
        model, val_loader, f"{args.model_name.upper()} Validation")
...
if __name__ == "__main__":
    ...
    visualize_box_samples(dataset, num_samples=6,
                          save_path='visualizations/box_samples.png')
