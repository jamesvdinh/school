...
def divide(quotients, divisors):
    ...
    """
    return {quo: [div for div in divisors if div % quo == 0] for quo in quotients}
...
def closer_city(lat, lon, city_a, city_b):
    ...
    """
    "*** YOUR CODE HERE ***"
    coord = make_city('coord', lat, lon)
    return get_name(city_a) if distance(city_a, coord) < distance(city_b, coord) else get_name(city_b)
