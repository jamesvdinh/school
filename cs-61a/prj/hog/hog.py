...
def boar_brawl(player_score, opponent_score):
    ...
    # BEGIN PROBLEM 2
    "*** YOUR CODE HERE ***"
    tens_dig = opponent_score // 10 % 10
    ones_dig = player_score % 10
    return max(1, 3 * abs(tens_dig - ones_dig))
    # END PROBLEM 2
...
def sus_points(score):
    ...
    "*** YOUR CODE HERE ***"
    pts = score
    if num_factors(pts) == 3 or num_factors(pts) == 4:
        while not is_prime(pts):
            pts += 1
    return pts
    # END PROBLEM 4
...
def sus_update(num_rolls, player_score, opponent_score, dice=six_sided):
    ...
    # BEGIN PROBLEM 4
    "*** YOUR CODE HERE ***"
    simplePts = simple_update(num_rolls, player_score, opponent_score, dice)
    return sus_points(simplePts)
    # END PROBLEM 4
