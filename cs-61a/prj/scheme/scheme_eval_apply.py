...
def scheme_apply(procedure, args, env):
    ...
    if isinstance(procedure, BuiltinProcedure):
        ...
        "*** YOUR CODE HERE ***"
        py_args = []
        while args is not nil and isinstance(args, Pair):
        ...
        # BEGIN PROBLEM 9
        "*** YOUR CODE HERE ***"
        f = Frame(procedure.env).make_child_frame(procedure.formals, args)
        return eval_all(procedure.body, f)
        # END PROBLEM 9
    elif isinstance(procedure, MuProcedure):
        # BEGIN PROBLEM 11
        "*** YOUR CODE HERE ***"
        f = Frame(env).make_child_frame(
...
def eval_all(expressions, env):
    ...
    val = expressions.first if expressions is not nil else None
