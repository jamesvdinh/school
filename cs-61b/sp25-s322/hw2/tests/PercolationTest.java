...
public class PercolationTest {
    ...
    private static final int INVALID_GRID_SIZE = -10;
    ...
    public void invalidGridSize() {
        try {
            new Percolation(INVALID_GRID_SIZE);
            fail("Expected IllegalArumentException thrown");
    ...
    @Test
    public void testBackwashFullOpenNumSites() {
        int N = 3;
        Percolation p = new Percolation(N);
        int[][] openSites = {
                {0, 0},
